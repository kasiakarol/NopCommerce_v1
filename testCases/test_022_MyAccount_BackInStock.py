...
class Test_022_MyAccountBackInStock():
    ...
    first_dp = ReadConfig.first_dp()
    last_dp = ReadConfig.last_dp()
    password_dp = ReadConfig.password_dp()
    ...
    def test_back_in_stock(self, setup):
        ...
        self.rp.setPassword(self.password_dp)
        self.rp.setConfirmPassword(self.password_dp)
        self.rp.clickRegister()

        self.hp.login()
        self.lp = LoginPage(self.driver)
        self.lp.insertEmail(self.email)
        self.lp.insertPassword(self.password_dp)
        self.lp.logIn()
